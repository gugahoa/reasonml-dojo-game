...
function Make(H) {
  ...
  var create = function (sz) {
    var sz$1 = sz < 7 ? 7 : sz;
    var sz$2 = sz$1 > max_array_length ? max_array_length : sz$1;
    return /* record */[
  ...
  var next_sz = function (n) {
    return Caml_primitive.caml_int_min((Caml_int32.imul(3, n) / 2 | 0) + 3 | 0, max_array_length);
  };
  ...
  var add_aux = function (t, setter, d, h, index) {
    ...
    while(true) {
      var i = _i;
      if (i >= sz) {
        var newsz = Caml_primitive.caml_int_min((Caml_int32.imul(3, sz) / 2 | 0) + 3 | 0, max_array_length - 1 | 0);
        if (newsz <= sz) {
          throw [
